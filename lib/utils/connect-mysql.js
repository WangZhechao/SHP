...
module.exports = function(session) {
	...
	MysqlStore.prototype.get = function(sid, cb) {
		...
		Promise.using(DB.getConn(), function(conn) {
	...
	MysqlStore.prototype.set = function(sid, data, cb) {
		...
		sql = 'REPLACE INTO `t_web_sessions` SET session_id = ?, expires = ?, data = ?';
		sql = DB.format(sql, [params.session_id, params.expires, params.data]);
